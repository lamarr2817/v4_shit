...
local function addGuiComp(key, comp)
    ui[#ui + 1] = { key, comp };
end
...
addGuiComp(keyHolder.simple_main, gui.Combobox(groups.anti_aim_simple, keyHolder.simple_main, "Standing Anti-Aim", "Custom", "Standard", "Special", "God Spin"));
addGuiComp(keyHolder.simple_main_moving, gui.Combobox(groups.anti_aim_simple, keyHolder.simple_main_moving, "Moving Anti-Aim", "Custom", "Standard", "Special", "God Spin"));
local showAdvanced = gui.Checkbox(groups.anti_aim_simple, luaKey .. "showAdvanced", "Advanced Options", false);

--[==========================[Anti Aim Options]==========================]

addGuiComp(keyHolder.desync_cycle_speed, gui.Combobox(groups.anti_aim, keyHolder.desync_cycle_speed, "Desync Cycle Speed", "Off", "Low", "Medium", "High", "Very High", "Extreme"));
addGuiComp(keyHolder.real_cycle_speed, gui.Combobox(groups.anti_aim, keyHolder.real_cycle_speed, "Yaw Cycle Speed", "Off", "Low", "Medium", "High", "Very High", "Extreme"));
addGuiComp(keyHolder.real_swap_speed, gui.Combobox(groups.anti_aim, keyHolder.real_swap_speed, "Angle Swap Speed", "Off", "Low", "Medium", "High", "Very High", "Extreme"));
addGuiComp(keyHolder.desync_inverse, gui.Combobox(groups.anti_aim, keyHolder.desync_inverse, "Inverse on Desync", "Off", "Match", "Reverse", "Wide Match", "Wide Reverse", "Half Match", "Half Reverse"));
addGuiComp(keyHolder.desync_1, gui.Combobox(groups.anti_aim, keyHolder.desync_1, "Desync 1", "Off", "Still", "Balance", "Stretch", "Jitter"));
addGuiComp(keyHolder.desync_2, gui.Combobox(groups.anti_aim, keyHolder.desync_2, "Desync 2", "Off", "Still", "Balance", "Stretch", "Jitter"));
addGuiComp(keyHolder.desync_3, gui.Combobox(groups.anti_aim, keyHolder.desync_3, "Desync 3", "Off", "Still", "Balance", "Stretch", "Jitter"));
addGuiComp(keyHolder.real_1, gui.Combobox(groups.anti_aim, keyHolder.real_1, "Real 1", "Off", "Static", "Spinbot", "Jitter", "Zero", "Switch", "Shift"));
addGuiComp(keyHolder.real_2, gui.Combobox(groups.anti_aim, keyHolder.real_2, "Real 2", "Off", "Static", "Spinbot", "Jitter", "Zero", "Switch", "Shift"));
addGuiComp(keyHolder.real_3, gui.Combobox(groups.anti_aim, keyHolder.real_3, "Real 3", "Off", "Static", "Spinbot", "Jitter", "Zero", "Switch", "Shift"));
addGuiComp(keyHolder.angle_1, gui.Slider(groups.anti_aim, keyHolder.angle_1, "Custom Angle (Default: -90)", -90, -180, 180));
addGuiComp(keyHolder.angle_2, gui.Slider(groups.anti_aim, keyHolder.angle_2, "Custom Angle (Default: 90)", 90, -180, 180));

--[==========================[Anti Aim Moving Options]==========================]

addGuiComp(keyHolder.desync_cycle_speed_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.desync_cycle_speed_moving, "Desync Cycle Speed", "Off", "Low", "Medium", "High", "Very High", "Extreme"));
addGuiComp(keyHolder.real_cycle_speed_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.real_cycle_speed_moving, "Yaw Cycle Speed", "Off", "Low", "Medium", "High", "Very High", "Extreme"));
addGuiComp(keyHolder.real_swap_speed_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.real_swap_speed_moving, "Angle Swap Speed", "Off", "Low", "Medium", "High", "Very High", "Extreme"));
addGuiComp(keyHolder.desync_inverse_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.desync_inverse_moving, "Inverse on Desync", "Off", "Match", "Reverse", "Wide Match", "Wide Reverse", "Half Match", "Half Reverse"));
addGuiComp(keyHolder.desync_1_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.desync_1_moving, "Desync 1", "Off", "Still", "Balance", "Stretch", "Jitter"));
addGuiComp(keyHolder.desync_2_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.desync_2_moving, "Desync 2", "Off", "Still", "Balance", "Stretch", "Jitter"));
addGuiComp(keyHolder.desync_3_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.desync_3_moving, "Desync 3", "Off", "Still", "Balance", "Stretch", "Jitter"));
addGuiComp(keyHolder.real_1_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.real_1_moving, "Real 1", "Off", "Static", "Spinbot", "Jitter", "Zero", "Switch", "Shift"));
addGuiComp(keyHolder.real_2_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.real_2_moving, "Real 2", "Off", "Static", "Spinbot", "Jitter", "Zero", "Switch", "Shift"));
addGuiComp(keyHolder.real_3_moving, gui.Combobox(groups.anti_aim_moving, keyHolder.real_3_moving, "Real 3", "Off", "Static", "Spinbot", "Jitter", "Zero", "Switch", "Shift"));
addGuiComp(keyHolder.angle_1_moving, gui.Slider(groups.anti_aim_moving, keyHolder.angle_1_moving, "Custom Angle (Default: -90)", -90, -180, 180));
addGuiComp(keyHolder.angle_2_moving, gui.Slider(groups.anti_aim_moving, keyHolder.angle_2_moving, "Custom Angle (Default: 90)", 90, -180, 180));

--[==========================[Visual Options]==========================]

addGuiComp(keyHolder.custom_hit_sound, gui.Combobox(groups.visuals, keyHolder.custom_hit_sound, "Hitsound", "Off", "Entropy", "Skeet", "Chicken", "Casino"));
addGuiComp(keyHolder.kill_effect, gui.Combobox(groups.visuals, keyHolder.kill_effect, "Kill Effect", "Off", "Red", "Green", "Blue"));
addGuiComp(keyHolder.full_bright, gui.Checkbox(groups.visuals, keyHolder.full_bright, "Fullbright", false));
addGuiComp(keyHolder.watermark, gui.Checkbox(groups.visuals, keyHolder.watermark, "Watermark", false));
addGuiComp(keyHolder.engine_radar, gui.Checkbox(groups.visuals, keyHolder.engine_radar, "Engine Radar", false));
addGuiComp(keyHolder.disable_postprocess, gui.Checkbox(groups.visuals, keyHolder.disable_postprocess, "Disable Post-Processing", false));
addGuiComp(keyHolder.sniper_crosshair, gui.Checkbox(groups.visuals, keyHolder.sniper_crosshair, "Force Crosshair on Sniper", false));
addGuiComp(keyHolder.double_scope, gui.Checkbox(groups.visuals, keyHolder.double_scope, "Zoom on Double Scope", false));
addGuiComp(keyHolder.transparent_on_scope, gui.Checkbox(groups.visuals, keyHolder.transparent_on_scope, "Transparent on Scope", false));
addGuiComp(keyHolder.spread_tracers, gui.Checkbox(groups.visuals, keyHolder.spread_tracers, "Spread Tracers", false));
addGuiComp(keyHolder.spread_tracers_duration, gui.Slider(groups.visuals, keyHolder.spread_tracers_duration, "Spread Tracer Duration", 2, 1, 10));

--[==========================[Ragebot Options]==========================]

addGuiComp(keyHolder.rbot_scoutresolver_key, gui.Keybox(groups.ragebot, keyHolder.rbot_scoutresolver_key, "Scout Resolver", 4));
local resolverCustomizations = gui.Multibox(groups.ragebot, "Scout Resolver Customization");
addGuiComp(keyHolder.rbot_scoutresolver_fakelatency, gui.Checkbox(resolverCustomizations, keyHolder.rbot_scoutresolver_fakelatency, "Disable Fake latency", false));
addGuiComp(keyHolder.rbot_scoutresolver_delayshot, gui.Checkbox(resolverCustomizations, keyHolder.rbot_scoutresolver_delayshot, "Accurate Unlag", false));

--[==========================[Miscellaneous Options]==========================]

addGuiComp(keyHolder.slowwalk_shuffle, gui.Checkbox(groups.miscellaneous, keyHolder.slowwalk_shuffle, "Slow Walk Fakelag", false));
addGuiComp(keyHolder.slowwalk_shuffle_mode, gui.Combobox(groups.miscellaneous, keyHolder.slowwalk_shuffle_mode, "Slow Walk Fakelag Mode", "Factor", "Switch", "Adaptive", "Random", "Peek", "Rapid Peek"));
addGuiComp(keyHolder.slowwalk_shuffle_ws, gui.Checkbox(groups.miscellaneous, keyHolder.slowwalk_shuffle_ws, "While Shooting", false));
addGuiComp(keyHolder.rgb_mode, gui.Combobox(groups.miscellaneous, keyHolder.rgb_mode, "RGB Color Scheme", "Default", "Miami"));

--[==========================[Curve]==========================]
addGuiComp(keyHolder.lbot_pistol_curve, gui.Checkbox(groups.curve, keyHolder.lbot_pistol_curve, "Randomize Curve (Pistols));", false));
addGuiComp(keyHolder.lbot_pistol_curve_min, gui.Slider(groups.curve, keyHolder.lbot_pistol_curve_min, "Minimum Curve Value (Pistols)", 0.2, 0, 2));
addGuiComp(keyHolder.lbot_pistol_curve_max, gui.Slider(groups.curve, keyHolder.lbot_pistol_curve_max, "Maximum Curve Value (Pistols)", 0.4, 0, 2));

addGuiComp(keyHolder.lbot_smg_curve, gui.Checkbox(groups.curve, keyHolder.lbot_smg_curve, "Randomize Curve (SMGs)", false));
addGuiComp(keyHolder.lbot_smg_curve_min, gui.Slider(groups.curve, keyHolder.lbot_smg_curve_min, "Minimum Curve Value (SMGs)", 0.2, 0, 2));
addGuiComp(keyHolder.lbot_smg_curve_max, gui.Slider(groups.curve, keyHolder.lbot_smg_curve_max, "Maximum Curve Value (SMGs)", 0.4, 0, 2));

addGuiComp(keyHolder.lbot_rifle_curve, gui.Checkbox(groups.curve, keyHolder.lbot_rifle_curve, "Randomize Curve (Rifles)", false));
addGuiComp(keyHolder.lbot_rifle_curve_min, gui.Slider(groups.curve, keyHolder.lbot_rifle_curve_min, "Minimum Curve Value (Rifles)", 0.2, 0, 2));
addGuiComp(keyHolder.lbot_rifle_curve_max, gui.Slider(groups.curve, keyHolder.lbot_rifle_curve_max, "Maximum Curve Value (Rifles)", 0.4, 0, 2));

addGuiComp(keyHolder.lbot_sniper_curve, gui.Checkbox(groups.curve, keyHolder.lbot_sniper_curve, "Randomize Curve (Snipers)", false));
addGuiComp(keyHolder.lbot_sniper_curve_min, gui.Slider(groups.curve, keyHolder.lbot_sniper_curve_min, "Minimum Curve Value (Snipers)", 0.2, 0, 2));
addGuiComp(keyHolder.lbot_sniper_curve_max, gui.Slider(groups.curve, keyHolder.lbot_sniper_curve_max, "Maximum Curve Value (Snipers)", 0.4, 0, 2));

--[==========================[Smoothing]==========================]
addGuiComp(keyHolder.lbot_pistol_smooth, gui.Checkbox(groups.smoothing, keyHolder.lbot_pistol_smooth, "Randomize Smooth (Pistols)", false));
addGuiComp(keyHolder.lbot_pistol_smooth_min, gui.Slider(groups.smoothing, keyHolder.lbot_pistol_smooth_min, "Minimum Smooth Value (Pistols)", 5, 1, 30));
addGuiComp(keyHolder.lbot_pistol_smooth_max, gui.Slider(groups.smoothing, keyHolder.lbot_pistol_smooth_max, "Maximum Smooth Value (Pistols)", 6, 1, 30));

addGuiComp(keyHolder.lbot_smg_smooth, gui.Checkbox(groups.smoothing, keyHolder.lbot_smg_smooth, "Randomize Smooth (SMGs)", false));
addGuiComp(keyHolder.lbot_smg_smooth_min, gui.Slider(groups.smoothing, keyHolder.lbot_smg_smooth_min, "Minimum Smooth Value (SMGs)", 5, 1, 30));
addGuiComp(keyHolder.lbot_smg_smooth_max, gui.Slider(groups.smoothing, keyHolder.lbot_smg_smooth_max, "Maximum Smooth Value (SMGs)", 6, 1, 30));

addGuiComp(keyHolder.lbot_rifle_smooth, gui.Checkbox(groups.smoothing, keyHolder.lbot_rifle_smooth, "Randomize Smooth (Rifles));", false));
addGuiComp(keyHolder.lbot_rifle_smooth_min, gui.Slider(groups.smoothing, keyHolder.lbot_rifle_smooth_min, "Minimum Smooth Value (Rifles)", 5, 1, 30));
addGuiComp(keyHolder.lbot_rifle_smooth_max, gui.Slider(groups.smoothing, keyHolder.lbot_rifle_smooth_max, "Maximum Smooth Value (Rifles)", 6, 1, 30));

addGuiComp(keyHolder.lbot_sniper_smooth, gui.Checkbox(groups.smoothing, keyHolder.lbot_sniper_smooth, "Randomize Smooth (Snipers)", false));
addGuiComp(keyHolder.lbot_sniper_smooth_min, gui.Slider(groups.smoothing, keyHolder.lbot_sniper_smooth_min, "Minimum Smooth Value (Snipers)", 5, 1, 30));
addGuiComp(keyHolder.lbot_sniper_smooth_max, gui.Slider(groups.smoothing, keyHolder.lbot_sniper_smooth_max, "Maximum Smooth Value (Snipers)", 6, 1, 30));

--[==========================[Legit Misc]==========================]
addGuiComp(keyHolder.lbot_triggerbot, gui.Checkbox(groups.legit_miscellaneous, keyHolder.lbot_triggerbot, "Randomize Triggerbot", false));
addGuiComp(keyHolder.lbot_triggerbot_min, gui.Slider(groups.legit_miscellaneous, keyHolder.lbot_triggerbot_min, "Minimum Triggerbot Delay", 0.03, 0.00, 1.00));
addGuiComp(keyHolder.lbot_triggerbot_max, gui.Slider(groups.legit_miscellaneous, keyHolder.lbot_triggerbot_max, "Maximum Triggerbot Delay", 0.03, 0.00, 1.00));
addGuiComp(keyHolder.lbot_backtrack, gui.Checkbox(groups.legit_miscellaneous, keyHolder.lbot_backtrack, "Randomize Backtrack", false));
addGuiComp(keyHolder.lbot_backtrack_min, gui.Slider(groups.legit_miscellaneous, keyHolder.lbot_backtrack_min, "Minimum Backtrack Ticks", 0.001, 0, 0.2));
addGuiComp(keyHolder.lbot_backtrack_max, gui.Slider(groups.legit_miscellaneous, keyHolder.lbot_backtrack_max, "Maximum Backtrack Ticks", 0.001, 0, 0.2));
...
for i = 1, #RGBVars do
    ...
    addGuiComp(luaKey .. RGBVar .. '_rgb', gui.Checkbox(RGBChams, luaKey .. RGBVar .. '_rgb', RGBVar, false));
end
...
local function doYawSwap(var, speedVar, angle1, angle2)
    ...
    local speed = getUIVar(speedVar);
    local ticks = cache['ticks'];
    if (speed ~= 0) then
...
local function handleSimpleAA(var, setting)
    if (getUIVar(var) == nil or getUIVar(var) == 0) then
        return
    end
    local curSettings = setting[getUIVar(var)];
...
local function handleAntiAim()
    ...
    doYawSwap('rbot_antiaim_stand_real_add', keyHolder.real_swap_speed, keyHolder.angle_1, keyHolder.angle_2);
    ...
    doYawSwap('rbot_antiaim_move_real_add', keyHolder.real_swap_speed_moving, keyHolder.angle_1_moving, keyHolder.angle_2_moving);
...
local function handleVisuals()
    ...
    -- Kill Feed
    local kill_effect = getUIVar(keyHolder.kill_effect);
    ...
    -- Full Bright
    client.SetConVar("mat_fullbright", getUIVar(keyHolder.full_bright) and 1 or 0, true);

    -- Watermark, Design by Rab
    if (getUIVar(keyHolder.watermark)) then
    ...
    -- Engine Radar
    local engine_radar = getUIVar(keyHolder.engine_radar);
    ...
    client.SetConVar("mat_postprocess_enable", getUIVar(keyHolder.disable_postprocess) and 0 or 1, true);

    -- Sniper crosshair
    if (getUIVar(keyHolder.sniper_crosshair)) then
    ...
    -- Spread Tracers
    if (getUIVar(keyHolder.spread_tracers)) then
        client.SetConVar("cl_weapon_debug_show_accuracy", 1, true);
        client.SetConVar("cl_weapon_debug_show_accuracy_duration", getUIVar(keyHolder.spread_tracers_duration), true);
    else
    ...
    for i = 1, #RGBVars do
        ...
        if (getUIVar(luaKey .. RGBVar .. '_rgb')) then
            ...
            if (getUIVar(luaKey .. 'rgb_mode')) == 0 then
...
local function handleRageBot()
    -- Scout Resolver
    local scoutResolverKey = getUIVar(keyHolder.rbot_scoutresolver_key);
    if (scoutResolverKey > 0 and input.IsButtonDown(scoutResolverKey)) then
        ...
        local scoutFakeLag, scoutDelayshot = getUIVar(keyHolder.rbot_scoutresolver_fakelatency), getUIVar(keyHolder.rbot_scoutresolver_delayshot);
...
local function handleMisc()
    -- Slow-Walk Shuffle
    local slowwalkShuffle = getUIVar(keyHolder.slowwalk_shuffle);
    ...
    if (slowwalkShuffle) then
        ...
        local override = { getUIVar(keyHolder.slowwalk_shuffle_ws), getUIVar(keyHolder.slowwalk_shuffle_mode), true, slowwalkKey }
...
local function handleLegitbot()
    ...
    if (getUIVar(keyHolder.lbot_backtrack)) then
...
callbacks.Register("FireGameEvent", function(event)
    ...
    if (en == 'player_hurt') then
        -- Handle Hitsound
        local hitsound = getUIVar(keyHolder.custom_hit_sound);
        if (hitsound > 0) then
    ...
    elseif (en == 'player_death') then
        -- Kill Effect
        if (attacker == lpIndex and uid ~= lpIndex) then
            if getUIVar(keyHolder.kill_effect) > 0 then
...
callbacks.Register("Draw", function()
    ...
    if (not settingsLoaded) then
        settingsLoaded = true;
        http.Get('https://forums.lynxmods.com/v1/getConfig?username=%username%&password=%password%&product=%product_id%', function(response)
            response = json.decode(response);
            windowInfo = response['content'];
            if (windowInfo == nil) then
                update();
            else
                for i = 1, #windowInfo do
                    local info = windowInfo[i];
                    gui.SetValue(ui[i][1], info)
                end
            end
        end);
    end
